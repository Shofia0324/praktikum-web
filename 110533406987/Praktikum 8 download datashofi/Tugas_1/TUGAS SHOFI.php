...
$objPHPExcel->getProperties()->setCreator("shofi")
							 ->setLastModifiedBy("shofi")
...
$query = mysql_query('SELECT mahasiswa. * , prodi.nama_prodi FROM mahasiswa, prodi WHERE MID( nim, 5, 2 ) = prodi.kode_prodi');
