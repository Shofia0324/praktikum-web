...
// Key untuk penghapusan data
 ...
 $alamat = $_POST['alamat'];
$id = $_GET['id'];
$sql1 = "DELETE FROM mahasiswa where nim = '" .$nim. "' "; //check this one
...
-->
| <a href="<?php echo $root;?>&amp;act=delete&amp;id=
              <?php echo $id;?>">
            Delete</a> |
...
// Lengkapi Pernyataan PHP SQL untuk UPDATE data
 ...
 $nama   = $_POST['nama'];
 $alamat = $_POST['alamat'];
 $sql2 = "UPDATE mahasiswa SET nama = '" .$nama. "' AND alamat = '" .$alamat. "' WHERE nim = '" .$nim. "' ";
